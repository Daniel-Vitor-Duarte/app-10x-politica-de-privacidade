        ...
        <section className="flex">
          <section className="flex flex-col bg-[#E3E3E3] w-full">
            ...
            <div className="w-[39.25rem] mx-auto">
              ...
              <p className="text-[0.875rem] text-[#828282] leading-[2rem] mt-[2rem]"><strong>A Ready To Go</strong> compartilhará os dados pessoais do titular para a plataforma Hotmart, a mesma que realiza a ativação do <strong>App10x.</strong></p>
            ...
            <div className="w-[39.25rem] mx-auto">
              ...
              <p className="text-[0.875rem] text-[#828282] leading-[2rem] mt-[2rem]">1. Seus dados coletados serão compartilhados com a plataforma HOTMART, a mesma que realizou a compra/ativação App10x.</p>
